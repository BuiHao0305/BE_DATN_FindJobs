                                        ...
                                        <tbody>
                                          <tr>
                                            <td style="width:100px;">
                                              <img height="auto" src="https://drive.usercontent.google.com/download?id=154z_fdeqKoCwMIsLLXJZFdpsx5D3i25Q&authuser=0" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="100" />
                                            </td>
                                          </tr>
                                        </tbody>
                                      </table>
        ...
        <tr>
          <td style="direction:ltr;font-size:0px;padding:10px 20px;text-align:center;">
            ...
            <td style="text-align: center; padding: 10px 0;">
              ...
              }" alt="Company Logo" style="width: 80px; height: auto; display: block; margin: auto; border: 0;" />
            </td>
          </tr>
                        </tbody>
                      </table>
                      ...
                      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000;">
                        <div style="text-align: center">
                          ...
                          <div style="margin-top: 10px">
                            <img src="https://drive.usercontent.google.com/download?id=154z_fdeqKoCwMIsLLXJZFdpsx5D3i25Q&authuser=0"></img>
                          </div>
                          ...
                          ">
                            ...
                            ">Bản quyền thuộc Bùi Hào © 2025</span>
